...
def createInstance():
    patterns = [
        ...
        (r"what is your name|whats your name|what's your name", ["Ah, the classic 'What's your name?' question. In the vast world of zeros and ones, I'm simply known as Digital Friend. Now that we're on a first-name basis, what can I do for you?",
        ...
        (r"quit|bye|exit|goodbye", ["Time to bid adieu! If you ever feel the urge to chat again, just remember, I'll be here in the digital cosmos. Until then, farewell and may your Wi-Fi always be strong!",
